...
from constants import JOINTS_NAME
...
class Visualize(object):
    ...
    def plot_2d(self, joints_2d, parents=None):
        if(parents is None):
            parents = PARENTS
    ...
    def plot_points_with_indices(self, joints_2d):
        fig = plt.figure(figsize=(16, 16))
        subplot = fig.add_subplot(111)
    ...
    def dump_all_images(self, data, width, height, output_dir_name="out"):
